...
- Create: `artifacts/模拟交易/阶段1委托生命周期/stage1-simulated-lifecycle-20260812T175300Z-0638c3587854/`
...
```bash
python3 scripts/模拟交易/验证阶段1委托生命周期.py prepare --batch stage1-simulated-lifecycle-20260812T175300Z-0638c3587854
python3 scripts/模拟交易/验证阶段1委托生命周期.py probe --batch stage1-simulated-lifecycle-20260812T175300Z-0638c3587854
python3 scripts/模拟交易/验证阶段1委托生命周期.py plan --batch stage1-simulated-lifecycle-20260812T175300Z-0638c3587854
python3 scripts/模拟交易/验证阶段1委托生命周期.py collect --batch stage1-simulated-lifecycle-20260812T175300Z-0638c3587854
python3 scripts/模拟交易/验证阶段1委托生命周期.py simulate --batch stage1-simulated-lifecycle-20260812T175300Z-0638c3587854
python3 scripts/模拟交易/验证阶段1委托生命周期.py replay-1 --batch stage1-simulated-lifecycle-20260812T175300Z-0638c3587854
python3 scripts/模拟交易/验证阶段1委托生命周期.py replay-2 --batch stage1-simulated-lifecycle-20260812T175300Z-0638c3587854
python3 scripts/模拟交易/验证阶段1委托生命周期.py validate --batch stage1-simulated-lifecycle-20260812T175300Z-0638c3587854
```
